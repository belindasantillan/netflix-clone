      ...
      <main className="pt-24 mx-auto max-w-6xl px-5 pb-12 transition-all md:px-10">
        <div className="flex flex-col gap-x-4 md:flex-row md:items-center">
          ...
          <div className="-ml-0.5 flex items-center gap-x-1.5">
            ...
            <p className="text-xs font-semibold text-[#555]">Member since January 18, 2024 </p>
          </div>
        </div>
        ...
        >
          ...
          {/* <div className="col-span-2 font-medium">{products.filter((product) => product.id === subscription?.product)[0]?.name}</div> */}
